...
UpdatePasswordParams _$UpdatePasswordParamsFromJson(Map<String, dynamic> json) {
  return _UpdatePasswordParams.fromJson(json);
}
...
mixin _$UpdatePasswordParams {
  ...
  /// Serializes this UpdatePasswordParams to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdatePasswordParams
...
class _$UpdatePasswordParamsImpl implements _UpdatePasswordParams {
  ...
  factory _$UpdatePasswordParamsImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdatePasswordParamsImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdatePasswordParams(oldPassword: $oldPassword, newPassword: $newPassword)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$UpdatePasswordParamsImplToJson(
      this,
    );
  }
}
...
abstract class _UpdatePasswordParams implements UpdatePasswordParams {
  ...
  factory _UpdatePasswordParams.fromJson(Map<String, dynamic> json) =
      _$UpdatePasswordParamsImpl.fromJson;
