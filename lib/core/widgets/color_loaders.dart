            ...
            child: Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<PtColors>()!.red,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<PtColors>()!.yellow,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<PtColors>()!.green,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<PtColors>()!.flamingo,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<PtColors>()!.lavender,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<PtColors>()!.pink,
                  ),
                ),
              ],
            ),
